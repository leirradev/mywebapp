...
<body>
	...
	<p>
		<a href="/mywebapp/admissionForm.html?siteTheme=green">Green</a>
		| <a href="/mywebapp/admissionForm.html?siteTheme=red">Red</a>
	</p>

	<a href="/mywebapp/admissionForm.html?siteLanguage=en">English</a>
	|
	<a href="/mywebapp/admissionForm.html?siteLanguage=fr">French</a>
	...
	<form action="/mywebapp/submitAdmissionForm.html"
		method="post">
		<table>
			<tr>
		...
		<table>
			...
			<tr>
				<td>
					<!-- country: --> <spring:message code="label.country" /><input
					type="text" name="studentAddress.country" />
				</td>
				<td>
					<!-- city: --> <spring:message code="label.city" /> <input
					type="text" name="studentAddress.city" />
				</td>
				<td>
					<!-- street: --> <spring:message code="label.street" /> <input
					type="text" name="studentAddress.street" />
				</td>
				<td>
					<!-- pincode: --> <spring:message code="label.pincode" /><input
			...
			<tr>
				<td><input type="submit"
					value="<spring:message code="label.submit.admissionForm"/>" /></td>
			</tr>
		</table>
	</form>
</body>
